...
namespace SLPCore.StackVM
{
    public class StackVM
    {
        ...
        public List<string> constStringPool = new List<string>();
        ...
        void Push8()
        {
            stack[stackPointer].i64 = BitConverter.ToInt64(bytecode, programCounter); //BitConverter is bottleneck, replace with shift+or number construction
            stackPointer++;
            programCounter += 8;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        void Jmp2()
        {
            programCounter += BitConverter.ToInt16(bytecode, programCounter) + 2; //BitConverter is bottleneck, replace with shift+or number construction
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        void JmpT2()
        {
        ...
        void PopL()
        {
            localVariables[BitConverter.ToUInt16(bytecode, programCounter)] = stack[--stackPointer]; //BitConverter is bottleneck, replace with shift+or number construction
            programCounter += 2;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        void PushL()
        {
            stack[stackPointer++] = localVariables[BitConverter.ToUInt16(bytecode, programCounter)]; //BitConverter is bottleneck, replace with shift+or number construction
            programCounter += 2;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        void Mills()
